...
const API_URL = process.env.DASHBOARD_API_URL || 'https://script.google.com/macros/s/AKfycbw0OIsvI4BVqjvR5kZXUzIOKP2bufrMY2X9qGfCYtF_3ye8_HbXbGv_OZu2ZYfThLLS/exec';
