...
const API_URL = process.env.DASHBOARD_API_URL || 'https://script.google.com/macros/s/AKfycbyARbpbKhXpzUCxsBmfcht4czjluHnjDkEyrZAz650OegQv5b3IIt2bzluF2IxAbFSN/exec';
