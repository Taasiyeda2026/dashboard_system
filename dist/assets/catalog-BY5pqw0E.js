const i="./catalog/summercatalog/",l="./catalog/summercatalog/course-page.html?catalog=admin",c="tsy_catalog_admin_token";function d(e){var a,o;return((a=e==null?void 0:e.user)==null?void 0:a.role)==="admin"||Number((o=e==null?void 0:e.user)==null?void 0:o.user_id)===8e3}function s(){if(document.getElementById("catalog-embed-screen-styles"))return;const e=document.createElement("style");e.id="catalog-embed-screen-styles",e.textContent=`
...
@media (max-width: 720px) {
  ...
  `.trim(),document.head.appendChild(e)}const p={render:(e,{state:a}={})=>(s(),`<section class="catalog-embed-screen" aria-labelledby="catalog-embed-title">
      <header class="catalog-embed-header">
        ...
        <div class="catalog-embed-actions">
          ${d(a)?`<div class="catalog-embed-admin-group">
          ...
          <a class="catalog-embed-open" href="${i}" target="_blank" rel="noopener noreferrer">פתח בחלון חדש</a>
        </div>
      </header>
    ...
    </section>`),bind({root:e,state:a}){if(!d(a))return;const o=e.querySelector("#catalog-admin-open-btn");o&&o.addEventListener("click",()=>{const t=e.querySelector("#catalog-admin-marketer-select"),n=(t==null?void 0:t.value)||"none";let r=l;n!=="none"&&(r+=`&marketer=${encodeURIComponent(n)}`);try{localStorage.setItem(c,JSON.stringify({ok:!0,exp:Date.now()+3e4}))}catch{}window.open(r,"_blank","noopener,noreferrer")})}};export{p as catalogScreen};
