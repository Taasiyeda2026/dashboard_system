import{q as i,a3 as d,i as l,j as o,a6 as p}from"./index-DpctzQJl.js";const g={load:({api:e})=>e.adminLists(),render(e){const s=Array.isArray(e==null?void 0:e.categories)?e.categories:[],n=s.length===0?i("אין רשימות"):s.map(r=>d({title:l(r.category),padded:!0,body:`
