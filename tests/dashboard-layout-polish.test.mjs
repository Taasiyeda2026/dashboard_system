...
test('desktop dashboard uses denser 60 percent content zoom while preserving existing tablet/mobile density', () => {
  ...
  assert.match(dashboardCss, /@media \(min-width: 1051px\)[\s\S]*#app \.ds-dashboard-wrap\s*\{[\s\S]*zoom:\s*0\.60;/);
