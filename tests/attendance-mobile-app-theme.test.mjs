...
test('Attendance mobile app theme is loaded last and scoped to mobile', () => {
  ...
  const followupIndex = index.indexOf('attendance-followup.css?v=66');
  const themeIndex = index.indexOf('mobile-app-theme.css?v=66');
