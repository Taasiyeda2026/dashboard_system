-- Enforce the user's explicit weekly day/time selections in manual finalization too.
-- Unselected weekdays are unavailable; selected weekdays must cover the full activity time.
