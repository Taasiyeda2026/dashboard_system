-- Weekly availability rules are the sole source of instructor workday/time constraints.
-- Friday is treated like every other weekday. Saturday remains sector-gated separately.
