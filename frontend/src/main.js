...
const screenLoaders = {
  ...
  'course-scheduling': () => import('./screens/course-scheduling.js?v=20260907-manual-modal-v1').then((m) => m.courseSchedulingScreen),
  ...
  'proposals-agreements': () => import('./screens/proposals-agreements.js?v=20260910-gefen-approval-opt-in-v2').then((m) => m.proposalsAgreementsScreen),
