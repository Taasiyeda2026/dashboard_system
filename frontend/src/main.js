...
const screenLabels = {
  ...
  exceptions: 'חריגות',
  instructors: 'מדריכים',
  'course-scheduling': 'שיבוץ פעילויות',
...
const screenLoaders = {
  ...
  'course-scheduling': () => import('./screens/course-scheduling.js?v=20260926-instructor-activity-details-v1').then((m) => m.courseSchedulingScreen),
  ...
  'proposals-agreements': () => import('./screens/proposals-agreements.js?v=20260912-client-drawer-cleanup-v1').then((m) => m.proposalsAgreementsScreen),
