...
const screenLoaders = {
  ...
  instructors: () => import('./screens/instructors.js?v=20260809-guides-list-assignment-filter-fix-v2').then((m) => m.instructorsScreen),
  'course-scheduling': () => import('./screens/course-scheduling.js?v=20260809-course-list-ui-polish-v1').then((m) => m.courseSchedulingScreen),
