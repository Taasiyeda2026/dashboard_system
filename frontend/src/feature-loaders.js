  ...
  switch (name) {
    ...
    case 'proposals':
      return loadOnce('proposals', () => Promise.all([
        ...
        import('./proposal-next-year-workshops.js?v=20260803-bundle-child-single-v1'),
        ...
        import('./proposal-next-year-approved-fix.js?v=20260803-v4'),
        ...
        import('./proposal-editor-compact-fixes.js?v=20260803-v7'),
