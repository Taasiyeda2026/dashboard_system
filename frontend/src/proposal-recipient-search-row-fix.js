function ensureRecipientFinalLayoutStyles() {
  ...
  style.textContent = `
    /* One outer box. Native search behavior stays untouched. */
    ...
    /* The compact runtime creates one active label. Hide the orphaned original label only. */
    ...
    #app .pa-editor-workspace [data-pa-client-search-field][hidden],
    ...
    /* After choosing an authority, the authority search becomes the selected value + mini Replace button. */
    ...
    #app .pa-editor-workspace .ds-pa-school-step-text {
      display: grid !important;
      grid-template-columns: 90px 54px !important;
      grid-template-rows: 18px var(--pa-recipient-control-height) !important;
      align-items: end !important;
      justify-content: start !important;
    ...
    #app .pa-editor-workspace [data-pa-change-authority-step]::after {
      content: 'החלף';
      font-size: 12px;
      font-weight: 700;
    }
    ...
    @media (max-width: 1120px) {
      ...
      #app .pa-editor-workspace .ds-pa-school-step-text {
        grid-template-columns: 66px 48px !important;
        inline-size: 120px !important;
        max-inline-size: 120px !important;
      }
