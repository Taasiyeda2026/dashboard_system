...
export function employeeFileModalHtml(payload = {}) {
  ...
  return `<div class="employee-file" data-employee-file-emp-id="${escapeHtml(payload.emp_id || '')}" dir="rtl">
    <style>
      ...
      .ds-modal--employee-file .ds-modal__content{width:100%;max-width:100%;padding:14px 18px 12px;overflow:visible;box-sizing:border-box}
      ...
      .employee-file__payroll-cell{display:grid;grid-template-rows:auto auto;place-items:center;align-content:center;gap:1px;min-width:0;height:29px;box-sizing:border-box;border-top:1px solid #e0e5ea;border-inline-start:1px solid #e0e5ea;background:#fbfcfd}
      .employee-file__payroll-cell:nth-child(-n+6){border-top:0}
      .employee-file__payroll-cell:nth-child(6n+1){border-inline-start:0}
      .employee-file__payroll-cell.is-missing{background:#fbfcfd}
      .employee-file__payroll-month{color:#788596;font-size:.56rem;font-weight:600;line-height:1}
      .employee-file__payroll-mark{min-height:.66rem;color:#28705b;font-size:.64rem;font-weight:800;line-height:1}
      ...
      .employee-file__admin-link{width:min(340px,100%);text-align:center;margin-inline:auto}
