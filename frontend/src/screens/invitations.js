...
.invitation-screen-root .c-main{padding:1.6mm 6mm 2mm;flex:1;display:flex;flex-direction:column;align-items:center;text-align:center}
.invitation-screen-root .c-title{font-weight:900;line-height:.95;margin-bottom:0;font-size:10.8mm}
.invitation-screen-root .c-sub-event{font-weight:700;line-height:1.08;margin-bottom:.6mm;font-size:5.6mm}
.invitation-screen-root .c-course{font-weight:500;line-height:1.04;margin-bottom:.6mm;font-size:6.1mm}
...
.invitation-screen-root .c-school{font-size:3.7mm;color:#333;margin:1mm 0}
.invitation-screen-root .c-school strong{font-weight:700}
.invitation-screen-root .c-divider{width:100%;height:1px;background:rgba(26,58,92,.1);margin:1mm 0}
.invitation-screen-root .c-opening{font-size:3.65mm;color:#333;line-height:1.22;margin:.7mm auto;max-width:none;width:88%;text-align:right;align-self:center;margin-inline:auto;padding-inline:2mm;box-sizing:border-box}
.invitation-screen-root .c-opening strong{font-weight:700;color:var(--accent-color,#1a8c6e)}
.invitation-screen-root .c-para{font-size:3.65mm;color:#333;line-height:1.22;margin:.4mm auto;text-align:right;max-width:none;width:88%;align-self:center;margin-inline:auto;padding-inline:2mm;box-sizing:border-box}
.invitation-screen-root .c-section-title{font-size:3.1mm;font-weight:800;color:var(--accent-color,#1a8c6e);line-height:1.15;margin:.8mm auto .25mm;max-width:none;width:88%;text-align:right;align-self:center;margin-inline:auto;padding-inline:0;box-sizing:border-box}
...
.invitation-screen-root .c-participants-box{width:82%;max-width:none;margin:.8mm auto;align-self:center;background:rgba(255,255,255,.38);border-color:rgba(26,140,110,.12);padding:.9mm 3mm}
.invitation-screen-root .c-details-box{width:82%;max-width:none;margin:.8mm auto;align-self:center;display:flex;flex-direction:column;align-items:center;gap:.35mm;background:transparent;border-color:rgba(26,140,110,.18);text-align:center;padding:1mm 3mm}
...
.invitation-screen-root .c-details-location{justify-content:center;text-align:center;width:100%;font-size:4.05mm;line-height:1.25}
.invitation-screen-root .c-details-box .c-info-row{justify-content:center;text-align:center}
.invitation-screen-root .c-info-row{display:flex;align-items:center;gap:4px;font-size:4mm;color:#333;line-height:1.25}
.invitation-screen-root .c-info-row strong{font-weight:700}
.invitation-screen-root .c-part-title{font-size:2.8mm;font-weight:700;margin-bottom:1px;line-height:1.22}
.invitation-screen-root .c-part-line{font-size:2.8mm;color:#333;line-height:1.22}
.invitation-screen-root .c-part-line strong{font-size:2.8mm;font-weight:700;color:#333;line-height:1.22}
.invitation-screen-root .c-part-line span{font-size:2.8mm;font-weight:400;line-height:1.22}
.invitation-screen-root .c-closing{font-size:5.1mm;font-weight:900;margin-top:1mm;padding-top:.5mm;text-align:center;line-height:1.05}
        ...
        return `
          <div class="c-footer">
            <div class="c-footer-sentence">
              ...
              <span style="color:#4cb7e8">מובילים דור אחד קדימה, </span>
              <span style="color:#fb1881">בחדשנות, </span>
              <span style="color:#f7a233">סקרנות ויזמות טכנולוגית</span>
            </div>
          </div>`;
      }
