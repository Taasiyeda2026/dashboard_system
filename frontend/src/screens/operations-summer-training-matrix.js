...
function addStyle(){
  ...
  s.textContent=`
    ...
    .ops-trx-wrap{overflow-y:auto;overflow-x:hidden;max-height:70vh;width:100%}.ops-trx table{border-collapse:collapse;table-layout:fixed;background:#fff;font-size:12px;width:100%}.ops-trx th,.ops-trx td{border:1px solid #cbd5e1;height:44px;line-height:44px;padding:0;text-align:center;vertical-align:middle;box-sizing:border-box;overflow:hidden;background:#fff}.ops-trx th{background:#f1f5f9;font-weight:800;color:#111827}.ops-trx thead th{position:sticky;top:0;z-index:5;box-shadow:0 2px 0 rgba(148,163,184,.32)}.ops-trx tr:nth-child(even) td{background:#f8fafc}
    ...
    .ops-trx-section td{height:40px;line-height:40px;background:#dff5fb!important;color:#075985;font-weight:900;text-align:right!important;padding-inline:14px!important;border-top:4px solid var(--ds-accent,#0292b7)!important;border-bottom:2px solid var(--ds-accent,#0292b7)!important}.ops-trx-section-title{position:static!important;text-align:right!important;background:#dff5fb!important}
