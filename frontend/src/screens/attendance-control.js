...
export function compareAttendanceRows(attendanceRows, dashboardRows) {
  ...
  return { comparisons, notCompared, dashboardOnly, dashboardPopulation };
}
...
.attendance-control__day{margin:10px 13px;padding:12px;border:1px solid;border-radius:9px}.attendance-control__day h4{display:flex;align-items:center;justify-content:space-between;gap:10px;margin:0}.attendance-control__day--ok{border-color:#86efac;background:#f0fdf4;color:#166534}.attendance-control__day--mismatch{border-color:#f59e0b;background:#fffbeb}.attendance-control__day--not-compared{border-color:#cbd5e1;background:#f8fafc;color:#475569}.attendance-control__row-status{font-weight:800;white-space:nowrap}.attendance-control__day-note{margin:8px 0 0;color:#92400e;font-weight:700}.attendance-control__diff{display:grid;grid-template-columns:minmax(110px,1fr) repeat(3,minmax(90px,1fr)) minmax(140px,1fr) minmax(110px,1fr);gap:7px;align-items:center;padding:7px 0;border-top:1px dashed #e2e8f0}.attendance-control__diff--header{border-top:none;border-bottom:1px solid #cbd5e1;padding-top:4px;padding-bottom:6px;margin-bottom:1px;color:#64748b;font-size:.82em;font-weight:700}.attendance-control__diff--header span{font-weight:700}.attendance-control__export{margin-top:14px}
@media(max-width:850px){.attendance-control__diff{grid-template-columns:1fr 1fr}.attendance-control__diff strong{grid-column:1/-1}.attendance-control__diff--header{display:none}[data-src-label]::before{content:attr(data-src-label)": ";font-weight:700;font-size:.8em;display:block;color:#64748b;margin-bottom:2px}}
</style>`;
}
