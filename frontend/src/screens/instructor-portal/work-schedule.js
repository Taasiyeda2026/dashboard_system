...
export const instructorWorkScheduleScreen = {
  ...
  render(data, { state } = {}) {
    ...
    return dsScreenStack(`<section class="instructor-area instructor-area--table ds-ops-mgmt-screen"><div class="ds-ops-mgmt-panel" dir="rtl">${dsPageHeader('סידור עבודה', 'הפעילויות המשויכות אליך בתשפ״ז')}${courseScheduleSummaryHtml(rows)}<div class="ds-ops-schedule-wrap"><section class="ds-card"><div class="ds-card__body">${courseScheduleTableHtml(rows, { expandedDates })}</div></section></div></div></section>`);
  },
