...
const PERMISSION_FIELD_LABELS = {
  ...
  view_employee_files: 'צפייה — תיקי עובד',
...
const API_ERROR_HE = {
  ...
  inactive_or_missing_username: 'שם משתמש לא פעיל או לא קיים',
  ...
  auth_ok_user_row_multiple_matches: 'ההתחברות הצליחה, אך נמצאו כמה פרופילים תואמים. יש לפנות למנהל המערכת.',
  ...
  invalid_or_inactive_code: 'שם משתמש או סיסמה שגויים',
  entry_code_is_required: 'יש להזין קוד כניסה',
  'entry_code is required': 'יש להזין קוד כניסה',
  invalid_user: 'שם משתמש או סיסמה שגויים',
