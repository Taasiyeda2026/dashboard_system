/**
 * shell-period-selector.js
 *
 * Exports syncGlobalActivityPeriodSelector — the only DOM sync helper for the
 * global period toggle button and option list.
 *
 * The year-switch click handler lives exclusively in
 * activity-period-selector-access-hotfix.js (capture phase, single source of
 * truth). The legacy route-guard microtask that used to live here has been
 * removed to eliminate handler conflicts.
 */
import {
